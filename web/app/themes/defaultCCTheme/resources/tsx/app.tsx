...
const solutionCards = [
  {
    title: "Architecture",
    description: "We design solid foundations that grow with your ambitions. Clear, maintainable and ready for the future.",
    className: "rounded-[40px_20px_20px_20px]"
  },
  {
    title: "Front-end Development", 
    description: "We craft user interfaces that don't just look good but feel intuitive and responsive. Whether it's a web app, dashboard or customer portal, our front-end developers ensure smooth interactions, accessible experiences and high performance across all devices.",
    className: "rounded-[20px]"
  },
  {
    title: "Back-end Development",
    description: "Behind every great interface is a solid engine. Our back-end experts build scalable, secure and future-ready systems that handle complex logic and data with ease. We focus on clean architecture, smart integrations and code that's built to last.",
    className: "rounded-[20px]"
  },
  {
    title: "Integration",
    description: "We connect systems in ways that just work. Smooth, safe and without the usual hassle.",
    ...
    <div className="bg-white overflow-hidden w-full relative">
        ...
        <div className="flex items-center gap-8">
          {navigationItems.map((item, index) => (
            <div key={index} className="flex items-center gap-0.5">
              <div className={`[font-family:'Lexend',Helvetica] font-medium text-lg text-center tracking-[0] leading-[22px] whitespace-nowrap ${
      ...
      <section className="relative px-4 pb-[119px]">
        <div className="max-w-7xl mx-auto px-[117px]">
          <div className="w-full min-h-[1000px] bg-gray-50 rounded-[20px_20px_60px_20px] border border-solid border-[#f0f2f2] p-[54px] relative bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'url(/app/themes/defaultCCTheme/resources/images/image-85.png)'}}>
            ...
            From strategic advisory to hands-on development,
                <br />
                we partner with you to create sustainable digital solutions that truly
                make a difference.
              </p>
           ...
           <RightTopCodeEditor />
            ...
            <div className="absolute right-8 lg:right-24 bottom-32 lg:bottom-40 w-80 lg:w-96 bg-gray-900 rounded-lg shadow-2xl rotate-1 z-20">
              ...
              <div className="p-4 font-mono text-xs text-green-400 bg-gray-900">
                ...
                <div className="mt-2 text-green-400">$<span className="animate-pulse">{'_'}</span></div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                your business forward. Our craftsmanship sets the standard for 
                quality, ensuring that your digital vision is not only realized but built 
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Developer as a Service</h3>
              </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="max-w-4xl mx-auto text-lg text-gray-600 leading-relaxed text-center">
              We take pride in adapting to your needs with clean, scalable solutions. 
              From architecture to front-end and back-end development, we build what
              works best for you using technologies that fit, without being tied to
              any one framework.
            </p>
          </div>
       ...
       {/* Solutions Grid */}
          <div className="grid grid-cols-4 gap-8">
            ...
            <Card className={cn("bg-gray-50 border border-solid border-[#f0f2f2] p-8", solutionCards[0].className)}>
...
<Card className="bg-gray-50 border border-solid border-[#f0f2f2] p-8 rounded-[20px] col-span-3 relative">
  <CardContent className="p-0">
    ...
    <div className="relative mb-8 h-[280px]">
      ...
      <div className="absolute left-0 top-0 w-[357px] h-[241px] bg-white rounded-lg shadow-xl border border-gray-200 transform -rotate-2 z-20">
        ...
        <div className="p-4 bg-white font-mono text-xs leading-relaxed">
          <div className="text-gray-500 mb-2">// 🚀 Craftcode Delivery Engine</div>
          <div className="text-purple-600">@PostMapping<span className="text-gray-800">(</span><span className="text-green-600">"/delivery-score"</span><span className="text-gray-800">)</span></div>
          <div className="text-blue-600">public Map&lt;String, Object&gt; <span className="text-yellow-600">score</span><span className="text-gray-800">(...) {`{`}</span></div>
          <div className="ml-2 text-gray-800">return Map.of(</div>
          <div className="ml-4 text-red-600">"team", <span className="text-orange-600">"Backend Guild"</span>,</div>
          <div className="ml-4 text-red-600">"deliveryScore", <span className="text-green-600">87.4</span>,</div>
          <div className="ml-4 text-red-600">"label", <span className="text-orange-600">"Elite"</span>,</div>
          <div className="ml-4 text-red-600">"craftedBy", <span className="text-orange-600">"Craftcode ✨"</span></div>
      ...
      <div className="absolute left-24 top-12 w-[357px] h-[241px] bg-white rounded-lg shadow-xl border border-gray-200 transform rotate-1 z-10">
        ...
        <div className="p-4 bg-white font-mono text-xs leading-relaxed">
          <div className="text-gray-800">local@MacBook % <span className="text-blue-600">./mvnw spring-boot:run</span></div>
          <div className="text-gray-600 mt-1">
            <span className="text-green-600">✔</span> Dependencies resolved
          </div>
          <div className="text-gray-600">
            <span className="text-green-600">✔</span> Build successful (14s)
          </div>
          <div className="text-gray-600">
            <span className="text-blue-600">[craftcode-demo]</span> Booting backend...
          </div>
          <div className="text-gray-600">
            <span className="text-green-600">☑</span> Database connected
          </div>
          <div className="text-gray-600">
            <span className="text-green-600">☑</span> Flyway migrations: 3 applied
          </div>
          <div className="text-gray-600">
            <span className="text-green-600">☑</span> HTTP server started on :8080
          </div>
          <div className="text-gray-600 mt-1">
            <span className="text-green-600">[READY]</span> Craftcode backend is up <span className="text-green-600">✔</span>
          </div>
        </div>
      </div>
    </div>
